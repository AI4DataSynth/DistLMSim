...
EPLB        : max=138  avg=125  deviation=743.0
Realistic   : max=314  avg=125  migrations=0
OmniPlace   : max=858  avg=125  migrations=4
```
...
│   │   ├── execution_time_predictor.py # Compute time (analytical/profiling/RF)
